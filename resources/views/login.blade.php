        ...
        <div class="col-lg-6">
            <div class="card">
                <div class="card-header">
                    <h1 class="card-title" style="color: #000;">LOGIN</h1>
                </div>
            <div class="card-body">
                ...
                <form action="{{ route('login') }}" method="POST">
                    ...
                    <div class="mb-3">
                        ...
                        <p class="text-center mt-3" style="color: black;">Don't have an account? <a href="/register" class="text-decoration-none">Register here</a>.</p>
